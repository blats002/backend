 ...
 */
public class GaeHostServerResource extends SelfInjectingServerResource {

    final static Logger LOG
            = LoggerFactory.getLogger(GaeHostServerResource.class);
...
//            String host = url.getHost();
            ...
            if(path.endsWith(ROOT_URI)){
                path = path + "index.html";
            } else if (path.isEmpty()){
                path = path + "/index.html";
            }

            LOG.info("Complete Path: " + _completePath);
            LOG.info("Request Path: " + path);
...
//            }
            ...
            if(subdomain == null){
                ...
                final String completePath = APP_ROOT_URI + path;

...
public class JeeRoleRepository extends JeeBaseRespository implements RoleRepository {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(JeeRoleRepository.class);
  ...
  public boolean updateRole(
    ...
    return updateRole(
        instance, namespace, entityType, entityId, roleName, read, write, publicRead, publicWrite);
  }
      ...
      entityStore.executeInTransaction(
          new StoreTransactionalExecutable() {
            ...
            public void execute(@NotNull final StoreTransaction txn) {
              ...
              String dateCreated =
                  (roleEntity.getProperty(Constants.RESERVED_FIELD_DATE_CREATED) != null
                      ? (String) roleEntity.getProperty(Constants.RESERVED_FIELD_DATE_CREATED)
                      : null);
              String dateUpdated =
                  (roleEntity.getProperty(Constants.RESERVED_FIELD_DATE_UPDATED) != null
                      ? (String) roleEntity.getProperty(Constants.RESERVED_FIELD_DATE_UPDATED)
                      : null);
  ...
  public boolean deleteRole(
      String instance, String namespace, String entityType, final String roleID) {
    final boolean[] success = {false};
    final PersistentEntityStore entityStore = manager.getPersistentEntityStore(xodusRoot, instance);
    try {
      entityStore.executeInTransaction(

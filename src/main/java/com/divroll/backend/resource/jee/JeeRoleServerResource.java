 ...
 * @since 0-SNAPSHOT
 */
public class JeeRoleServerResource extends BaseServerResource implements RoleResource {

  private static final Logger LOG = LoggerFactory.getLogger(JeeRoleServerResource.class);

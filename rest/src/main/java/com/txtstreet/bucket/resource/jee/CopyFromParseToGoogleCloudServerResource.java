...
import com..bucket.resource.CopyFromParseToGoogleCloud;
                        ...
                        Runnable runnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    com.mashape.unirest.http.HttpResponse<String> quotaRequest = Unirest.get(Configuration.TXTSTREET_PARSE_URL +
                                            "/classes/Application/" + appPointer.getString("objectId"))
                                            .header("X-Parse-Application-Id", Configuration.TXTSTREET_PARSE_APP_ID)
                                            .header("X-Parse-REST-API-Key", Configuration.TXTSTREET_PARSE_REST_API_KEY)

...
public class ACMEService {
    ...
    private static final Logger LOG
            = Logger.getLogger(ACMEService.class.getName());
    ...
    private Registration findOrRegisterAccount(Session session) throws AcmeException {
        LOG.info("Find Or Register account enter");
        ...
        try {
            ...
            System.out.println("Done agreement");
            ...
            reg = new RegistrationBuilder().create(session);
            URI agreement = reg.getAgreement();
            acceptAgreement(reg, reg.getAgreement());

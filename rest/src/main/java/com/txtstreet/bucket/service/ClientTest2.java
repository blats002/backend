...
//    private static final Logger LOG = LoggerFactory.getLogger(ClientTest2.class);
    ...
    public void fetchCertificate(Collection<String> domains) throws IOException, AcmeException {
        ...
        LOG("Success! The certificate for domains " + domains + " has been generated!");
        LOG("Certificate URI: " + certificate.getLocation());
    ...
    private Registration findOrRegisterAccount(Session session) throws AcmeException {
        ...
        try {
            ...
            LOG("Registered a new user, URI: " + reg.getLocation());
            ...
            LOG("Terms of Service: " + agreement);
            ...
            LOG("Account does already exist, URI: " + reg.getLocation(), ex);
        }
    ...
    private void authorize(Registration reg, String domain) throws AcmeException {
        ...
        LOG("Authorization for domain " + domain);
    ...
    public Challenge httpChallenge(Authorization auth, String domain) throws AcmeException {
        ...
        LOG("Please create a file in your web server's base directory.");
        LOG("It must be reachable at: http://" + domain + "/.well-known/acme-challenge/" + challenge.getToken());
        LOG("File name: " + challenge.getToken());
        LOG("Content: " + challenge.getAuthorization());
        LOG("The file must not contain any leading or trailing whitespaces or line breaks!");
        LOG("If you're ready, dismiss the dialog...");
    ...
    public Challenge dnsChallenge(Authorization auth, String domain) throws AcmeException {
        ...
        // Output the challenge, wait for acknowledge...
        LOG("Please create a TXT record:");
        LOG("_acme-challenge." + domain + ". IN TXT " + challenge.getDigest());
        LOG("If you're ready, dismiss the dialog...");
    ...
    public Challenge tlsSniChallenge(Authorization auth, String domain) throws AcmeException {
        ...
        // Output the challenge, wait for acknowledge...
        LOG("Please configure your web server.");
        LOG("It must return the certificate 'tlssni.crt' on a SNI request to:");
        LOG(subject);
        LOG("The matching keypair is available at 'tlssni.key'.");
        LOG("If you're ready, dismiss the dialog...");
...
//        if (args.length == 0) {
//            System.err.println("Usage: ClientTest2 <domain>...");
//            System.exit(1);
//        }
//
//        LOG("Starting up...");
        ...
        Collection<String> domains = Arrays.asList("www2.sample123123.com");
        try {
            ClientTest2 ct = new ClientTest2();
            ct.fetchCertificate(domains);
        } catch (Exception ex) {
            LOG("Failed to get a certificate for domains " + domains, ex);
        }
    }

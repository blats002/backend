...
import com.divroll.bucket.resource.jee.BaseServerResource;
...
public class HttpChallengeListener implements AcmeChallengeListener, BaseService{
    ...
    private boolean createChallengeFiles(String token, String challengeBody) {
        ...
        try {
            ...
            LOG.info("Method:    " + "createChallengeFiles");
...
//                        .header("Content-Type", mimeType)
                ...
                if(response.getStatus() == 201){
                    ...
                    HttpResponse<String> updateResponse = Unirest.post(Configuration.DIVROLL_PARSE_URL +
                            "/classes/File")
                            .header(X_PARSE_APPLICATION_ID, Configuration.DIVROLL_PARSE_APP_ID)
                            .header(X_PARSE_REST_API_KEY, Configuration.DIVROLL_PARSE_REST_API_KEY)
                            .header(X_PARSE_SESSION_TOKEN, sessionToken)

 ...
 * @since 1.0
 */
public class TestDuplicateQuotaMeterMethod extends TestCase {
	 ...
	 */
	public TestDuplicateQuotaMeterMethod(String testName ) {
		super( testName );
	}
	...
	public static Test suite() {
		return new TestSuite( TestDuplicateQuotaMeterMethod.class );
	}

	public void testDuplicateMethod() {
		DuplicateQuotaMeterMethod method = new DuplicateQuotaMeterMethod();
		...
		assertEquals("duplicate", method.getMethodName());
